...
const defaultSchema = location => {
  ...
  return {
    ...
    brandSocialArr: {
      instagram: "https://www.instagram.com/aumentados_",
      facebook: "https://www.facebook.com/aumentados_",
      linkedIn: "https://www.linkedin.com/company/aumentados_",
      youtube: "asd",
      twitter: "asd",
    },
...
const articleSchema = (data, location) => {
  ...
  return {
    ...
    brandName: organization.name,
    brandSocialArr: {
      instagram: "https://www.instagram.com/aumentados_schema",
      facebook: "https://www.facebook.com/aumentados_schema",
      linkedIn: "https://www.linkedin.com/company/aumentados_schema",
      youtube: "asd",
      twitter: "asd",
    },
    buildServerUrl: siteUrl || "/",
