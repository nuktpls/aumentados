...
**Plugin URI:** https://www.npmjs.com/package/gatsby-theme-aumentados

**Plugin Install:** `npm i gatsby-theme-aumentados`
...
```javascript
module.exports = {
  plugins: [`gatsby-theme-aumentados`],
};
// gatsby-config.js
```
